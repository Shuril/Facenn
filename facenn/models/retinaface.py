...
# Standard RetinaFace Implementation components
# Adapted from biubug6/Pytorch_Retinaface for Facenn
...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase='train'):
        ...
        # ResNet50 backbone setup
        import torchvision.models._utils as _utils
        resnet = models.resnet50(weights=None) # We load custom weights
        
        # Freezing logic if needed, skipping here
        self.body = _utils.IntermediateLayerGetter(resnet, {'layer2': 1, 'layer3': 2, 'layer4': 3})
        ...
        # For ResNet50, layer 2 is 512, layer 3 is 1024, layer 4 is 2048
